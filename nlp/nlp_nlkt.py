...
ANTHROPIC_API_KEY = "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"
...
def retrieve_relevant_sentences(query, top_k=3):
    ...
    return [match["text"] for match in results["metadatas"][0]] if results["metadatas"] else []
...
def generate_answer_with_rag(question):
    ...
    context_text = " ".join(retrieved_context) if retrieved_context else "No relevant context found."
